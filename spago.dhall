...
, dependencies =
  ...
  , "effect", "prelude", "bifunctors", "record", "functors", "affjax", "affjax-web", "strings"
  , "partial", "unordered-collections", "formatters", "halogen", "halogen-subscriptions", "web-html"
  , "web-events", "web-uievents", "web-pointerevents", "unsafe-coerce", "console"
  ]
, packages = 
